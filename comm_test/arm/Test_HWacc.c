...
int main(int argc, char **argv)
{
	...
	poll_address = mem_address + 2*1024*4;
  ...
  printf("TEST HW ACCELERATOR \n");
	/*======================================================================================
	Map the kernel memory location starting from mem_address to the User layer
	========================================================================================*/
  ...
  mem_mmap = mmap(NULL, page_size, PROT_READ|PROT_WRITE, MAP_SHARED, fd_cpy, mem_address);
	...
	/*======================================================================================
	Copy the Data to the DDR Memory at location mem_address
 	========================================================================================*/
