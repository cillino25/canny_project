...
//  	imwrite("Dx.bmp", sobelDxOut);
//  	imwrite("Dy.bmp", sobelDyOut);

	gettimeofday(&stop, NULL);
//  	printf("...copying wall time:           %3.3lf ms\n\n", ((stop.tv_sec + stop.tv_usec*0.000001)-(start.tv_sec + start.tv_usec*0.000001))*PRESC *1000);
