...
main(int argc, char *argv[])
{
	...
	printf("Whetstone benchmark started...\n");
	long I;
...
*/
	...
	KIPS = (100.0*LOOP*II)/(fini-start);
	if (KIPS >= 1000.0)
		printf("C Converted Double Precision Whetstones: %.5f MIPS\n", KIPS/1000.0);
	else
		printf("C Converted Double Precision Whetstones: %.5f KIPS\n", KIPS);
