...
/* TIME TIME TIME TIME TIME TIME TIME TIME TIME TIME TIME TIME TIME */
   ...
   /*REAL second()
    ...
    REAL second(){
        ...
        return ((REAL)t.tv_sec + (REAL)t.tv_usec * 0.000001)*1000/25;
    }
...
main ()
{
    printf("\nLinpack benchmark started with options: ");
    printf("Prec=%s, Rolling=%s\n\n", PREC, ROLLING);
 ...
 ************************************************************************/
        ...
        fprintf(stderr," Precision %11.6f Mflops \n\n",mflops);
