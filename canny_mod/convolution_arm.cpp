...
///////////////////////////////////////////////////////////////////////////////
// unsigned char (8-bit) version - floating point kernel coefficients
///////////////////////////////////////////////////////////////////////////////
...
bool convolve2DSeparable(unsigned char* in, unsigned char* out, int dataSizeX, int dataSizeY, 
                         int* kernelX, int kSizeX, int* kernelY, int kSizeY, int normalization)
{
    //printf("convolve2DSeparable - int version\n");
    int i, j, k, m, n;
    int *tmp, *sum;                              // intermediate data buffer
    unsigned char *inPtr, *outPtr;                  // working pointers
    int *tmpPtr, *tmpPtr2;                       // working pointers
    int kCenter, kOffset, endIndex;                 // kernel indice
    ...
    // allocate temp storage to keep intermediate result
    tmp = new int[dataSizeX * dataSizeY];
    if(!tmp) return false;  // memory allocation error

    // store accumulated sum
    sum = new int[dataSizeX];
    if(!sum) return false;  // memory allocation error
...
///////////////////////////////////////////////////////////////////////////////
// unsigned char (8-bit) version - long kernel coefficients
///////////////////////////////////////////////////////////////////////////////
bool convolve2DSeparable(unsigned char* in, unsigned char* out, int dataSizeX, int dataSizeY, 
                         long* kernelX, int kSizeX, long* kernelY, int kSizeY, long normalization, int div_type)
{
    ...
    unsigned char *inPtr, *outPtr;                  // working pointers
    long *tmpPtr, *tmpPtr2;                       // working pointers
    int kCenter, kOffset, endIndex;                 // kernel indice
    ...
    // allocate temp storage to keep intermediate result
    tmp = new long[dataSizeX * dataSizeY];
    if(!tmp) return false;  // memory allocation error

    // store accumulated sum
    sum = new long[dataSizeX];
    if(!sum) return false;  // memory allocation error
