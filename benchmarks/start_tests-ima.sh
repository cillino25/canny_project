...
echo "################################ Dhrystone_mod #####################################"
echo "./fesvr-zynq pk_rv64ima dhrystone_mod.riscv"
./fesvr-zynq pk_rv64ima dhrystone_mod.riscv

echo "################################   Whetstone   #####################################"
echo "./fesvr-zynq pk_rv64ima whetstone.riscv"
./fesvr-zynq pk_rv64ima whetstone.riscv

echo "################################   Linpack   #####################################"
echo "./fesvr-zynq pk_rv64ima linpack.riscv"
./fesvr-zynq pk_rv64ima linpack.riscv
